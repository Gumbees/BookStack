...
return [
    ...
    'oauth_clients_desc' => 'OAuth clients that have registered with this BookStack instance. Clients allow external applications to authenticate users via the OAuth 2.0 protocol.',
    'oauth_clients_none' => 'No OAuth clients have been registered.',
    'oauth_client' => 'OAuth Client',
    'oauth_client_id' => 'Client ID',
    'oauth_client_updated' => 'OAuth client successfully updated.',
    'oauth_client_deleted' => 'OAuth client successfully deleted.',
    'oauth_client_delete' => 'Delete OAuth Client',
    'oauth_client_delete_warning' => 'This will fully delete this OAuth client, with the name \':clientName\', from the system. All active user authorizations and tokens for this client will be revoked.',
    'oauth_client_delete_confirm' => 'Are you sure you want to delete this OAuth client?',
    'oauth_instance_approved' => 'Instance Approved',
    'oauth_instance_approved_desc' => 'When enabled, users authenticating with this client will skip the consent screen. They still need to sign in, but won\'t be asked to authorize the application.',
    'oauth_redirect_uris' => 'Redirect URIs',
    'oauth_created_by' => 'Created by :user',
    'oauth_registered_dynamically' => 'Registered via dynamic client registration',
    'oauth_x_active_tokens' => ':count active token|:count active tokens',
    'oauth_active_authorizations' => 'Active Authorizations',
    'oauth_active_authorizations_desc' => 'Users who have authorized this client to access their account.',
    'oauth_last_used' => 'Last used',
    'oauth_revoke' => 'Revoke',
    'oauth_authorization_revoked' => 'OAuth authorization successfully revoked.',
    'oauth_authorized_apps' => 'Authorized Applications',
    'oauth_authorized_apps_desc' => 'External applications that have been granted access to your account via OAuth.',
